...
If you need access to a portal, ask the person who set up your organisation's Ubuntu Pro subscription to add you to the portals required. Note that you will need to be granted access to each of the three customer portals separately because they do not have an integrated user database. 
