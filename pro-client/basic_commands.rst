...
.. note::
    ...
    is, refer to our
    :ref:`explanation on the different columns<pro-client-docs:pro-status-output>`.
...
.. hint::
    ...
    at :ref:`this deeper explanation<pro-client-docs:expl-pro-refresh>`.
...
:ref:`how-to guides<pro-client-docs:how-to>`.
